        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LibraryLogoUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageBookCoverPath = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PricePhysical = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PricePdf = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    PricePDFPerDay = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_vendorIdentityImagesUrls", x => x.Id);
                    table.ForeignKey(
                        name: "FK_vendorIdentityImagesUrls_Vendors_VendorId",
                        column: x => x.VendorId,
                        principalTable: "Vendors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_vendorIdentityImagesUrls_VendorId",
                table: "vendorIdentityImagesUrls",
                column: "VendorId");
